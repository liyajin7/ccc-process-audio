...
def parse_args():
    ...
    parser.add_argument('outdir', help='output/cache directory')
...
def cli(prep_tasks, **kwargs):
    args = parse_args()
    args = vars(args)
    args = kwargs.update(args)
    ...
    kls = CudaTranscriber if args['cuda'] else MultiTranscriber
    params = {
        'cache_only': True,
        'progress': True,
